                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <?=anchor('/professor','<i class="far fa-circle nav-icon"></i><p>Cadastrar</p>',['class'=>'nav-link active']);?>
                                    
                                </li>
                                <li class="nav-item">
                                    <?=anchor('/professor/list','<i class="far fa-circle nav-icon"></i><p>Listar</p>',['class'=>'nav-link active']);?>
